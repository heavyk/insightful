...
function Conductor() {
    // if(!(this instanceof Conductor)) return new Conductor;
...
function Conductor$removeAllListeners( type ) {
    ...
    if( type === void 0 ) {
        ...
        var insights = this._insights = new Array( this._insights.length );
...
function Conductor$_doCompact() {
    ...
    var len = insights.length;
    var skips = 0;
    for( var i = 0; i < len; i += insightSpace ) {
